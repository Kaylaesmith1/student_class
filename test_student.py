...
class TestStudent(unittest.TestCase):
    ...
    * Assert whether the instance's end_date equals the old end_date plus the days argument that was passed in using timedelta
    ...
    * Run the tests to confirm they are working
    ...
    # use camelCase otherwise tests won't run
    def setUp(self):
        print('setUp')
    ...
    def test_course_scheudle_success(self):
